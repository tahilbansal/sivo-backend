const sendPushNotification = require("./sendNotification");
 ...
 function sendDeliveredOrderToSupplier(token, orderId) {
    if (token && token !== null) {
...
module.exports = {sendDeliveredOrder,sendPayoutRequestNotification, sendDeliveredOrderToSupplier, sendOrderPickedUp, sendOrderPreparing, sendOrderWaitingForCourier}